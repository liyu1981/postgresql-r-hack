...
/*
 * Xact replication levels
 */
#define XACT_REPL_SYNC			0
#define XACT_REPL_EAGER			1
#define XACT_REPL_LAZY			2

extern int	DefaultXactReplLevel;
extern int	XactReplLevel;
...
extern void StartSubTransaction(void);
extern void CommitSubTransaction(void);
extern void AbortSubTransaction(void);

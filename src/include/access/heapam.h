...
extern void heap_delete_internal(Relation relation, HeapTuple oldtup,
								 Buffer buffer, CommandId cid);
extern HTSU_Result heap_update(Relation relation, ItemPointer otid,
			HeapTuple newtup,
			ItemPointer ctid, TransactionId *update_xmax,
			CommandId cid, Snapshot crosscheck, bool wait);
extern void heap_update_internal(Relation relation, HeapTuple oldtup,
								 HeapTuple newtup, Buffer buffer,
								 CommandId cid);

...
/* for replication, in replication/recovery.c or in adt/misc.c if replication
 * is disabled */
extern Datum pg_adapt_from_pg90_shared_schema(PG_FUNCTION_ARGS);
extern Datum pg_adapt_from_pg90_schema(PG_FUNCTION_ARGS);

...
/* replication */
DATA(insert OID = 8007 (  pg_adapt_from_pg90_shared_schema	PGNSP PGUID 12 1 0 0 f f f t f v 1 0 25 "25" _null_ _null_ "{other_nsp}" _null_ pg_adapt_from_pg90_shared_schema _null_ _null_ _null_ ));
DESCR("replication: adapt shared system catalogs from Postgres 8.4");
DATA(insert OID = 8008 (  pg_adapt_from_pg90_schema	PGNSP PGUID 12 1 0 0 f f f t f v 1 0 25 "25" _null_ _null_ "{other_nsp}" _null_ pg_adapt_from_pg90_schema _null_ _null_ _null_ ));
DESCR("replication: adapt a database's system catalogs from Postgres 8.4");

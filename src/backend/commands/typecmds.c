...
DefineType(List *names, List *parameters)
{
	...
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to create type in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to drop type in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to create domain in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to create enum in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to create composite type in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to alter domain in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to rename type in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to alter type in replicated mode.");
#endif

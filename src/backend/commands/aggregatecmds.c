...
DefineAggregate(List *name, List *args, bool oldstyle, List *parameters)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to create aggregate in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to remove aggregate in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to rename aggregate in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to alter aggregate in replicated mode.");
#endif

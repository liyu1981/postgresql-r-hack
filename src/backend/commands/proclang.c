...
CreateProceduralLanguage(CreatePLangStmt *stmt)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to create procedural language in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to drop procedural language in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to rename procedural language "
			 "in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to alter procedural language in replicated mode.");
#endif

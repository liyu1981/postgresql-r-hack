...
PrepareQuery(PrepareStmt *stmt, const char *queryString)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to prepare a statement in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to execute a prepared statement "
			 "in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to drop prepared statement in replicated mode.");
#endif

...
CreateConversionCommand(CreateConversionStmt *stmt)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to create conversion in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to drop conversion in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to rename conversion in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to alter conversion in replicated mode.");
#endif

...
DefineOperator(List *names, List *parameters)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to create operator in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to remove operator in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to alter operator in replicated mode.");
#endif

			  ...
			  bool isInternal)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to create trigger in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to drop trigger in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to rename trigger in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to enable or disable trigger "
			 "in replicated mode.");
#endif

...
DefineRelation(CreateStmt *stmt, char relkind)
{
	...
	if (replication_enabled && !IsBackgroundWorkerProcess())
		elog(ERROR, "Unable to create relation in replicated mode.");
#endif
...
RemoveRelations(DropStmt *drop)
{
	...
	if (replication_enabled)
		elog(ERROR, "Unable to drop relation in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to truncate relation in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to rename relation in replicated mode.");
#endif
...
#ifdef REPLICATION
	if (replication_enabled)
		elog(ERROR, "Unable to alter table in replicated mode.");
#endif
